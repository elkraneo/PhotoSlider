...
class PhotoSliderImageView: UIView, UIScrollViewDelegate {
    
    var imageView:UIImageView!
    var scrollView:UIScrollView!
    var progressView: PhotoSliderKit.PhotoSliderProgressView!
    ...
    func initialize() {
        ...
        // progress view
        self.progressView = PhotoSliderProgressView(frame: CGRect(x: 0.0, y: 0.0, width: 40.0, height: 40.0))
