...
/// The indicator view showing when loading. This will be <code>nil</code> if <code>kf_showIndicatorWhenLoading</code> is false.
/// You may want to use this to set the indicator style or color when you set <code>kf_showIndicatorWhenLoading</code> to true.
